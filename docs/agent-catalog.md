...
| PSD Orchestrator | [psd-orchestrator.agent.md](../.github/agents/psd-orchestrator.agent.md) | Coordinate the PSD workflow, resume from breakpoints, and manage deterministic stage handoffs | [Pipeline Guide](problem-statement-decomposition-pipeline.md#entrypoint) | Integrator |
